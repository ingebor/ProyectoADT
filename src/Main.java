...
public class Main {
	...
	public static void main (String [] args) throws Exception{
    	...
    	if(archive.exists()) {
	        ...
	        //BufferedReader b = new BufferedReader(archive);
	    	Scanner b = new Scanner(archive);
	        code = b.nextLine();
        ...
        System.out.println(splitInst(split(code))+ "Separa el código");
    	}
    ...
    public static void executeFun(ArrayList<ArrayList<String>> operaciones, HashMap<String, Funcion> funciones){
       System.out.println(operaciones);
        ...
        for (int i = 0; i<operaciones.size(); i++){
        	//System.out.println(operaciones.get(i).get(2));
        ...
        for (int i = 0; i<operaciones.size();i++){
            //Busca de operadores
        	System.out.println(operaciones.get(i).get(7));
...
//        }
    ...
    public static String evaluarPredicados(String[] matriz){
        ...
        switch (matriz[i].toUpperCase()) {
            ...
            case "<":
                @SuppressWarnings("unused") ArrayList<Double> numeros = new ArrayList<Double>();
